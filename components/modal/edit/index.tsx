...
//interfaces
import { EditModalComponentProps } from "@/interfaces";

export default function EditModal(props: EditModalComponentProps){
    ...
    const loadingTitle = "Saving Changes..."
    const loadingDescription = "Please Wait..."

    const errorTitle = "Save Changes Failed"
    const errorDescription = "Please Click Retry Button for Retry"

    const successTitle = "Save Changes Success"
